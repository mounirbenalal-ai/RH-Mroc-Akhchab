...
import { LayoutDashboard, Users, ClipboardCheck, Settings, Trees, FolderOpen } from 'lucide-react';
    ...
    <div className="flex h-screen bg-stone-50 font-sans text-right" style={{ direction: 'rtl' }}>
      ...
      <main className="flex-1 overflow-auto bg-stone-50">
        <header className="h-16 bg-white border-b border-stone-200 flex items-center px-8 shadow-sm justify-between">
          ...
          <div className="text-sm text-stone-400 font-medium">نظام التشغيل الذكي v1.0</div>
        </header>
        ...
        <div className="p-8">
          ...
          {activeTab === 'settings' && (
            <div className="bg-white p-10 rounded-3xl shadow-sm text-center">
              ...
              <p className="text-stone-500 italic">الإعدادات قيد التطوير لتناسب احتياجات المصنع...</p>
            </div>
          )}
        </div>
      </main>
